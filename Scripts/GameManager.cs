...
public partial class GameManager : Node
{
    ...
    {
        GD.Print("GameManager getting ready...");
        Instance = this;
    ...
    public void StartGame()
    {
        ...
        StartUI = GetTree().Root.GetNode<StartUI>("Core_Spikeball/StartUI");
        ...
        for (int i = 1; i <= 4; i++)
        {
            Player player = new Player
            {
                ...
                Color = PlayerData.PlayerColorMap[i]
            };
            Players.Add(i, player);
            PlayerScores.Add(i, 0);
            PlayerHasBeenBallRecently.Add(i, false);
        }
